...
BEGIN
    ...
    SET final_query = CONCAT(
        ...
        'JOIN copo_students_details csd ON me.sid = csd.sid ',
        'WHERE ue.usercourseid = ', p_usercourseid, ' ',
        'GROUP BY me.sid'
    );
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetMiniProjectMarks` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    ELSE
        ...
        SET @sqlQuery = CONCAT(
            ...
            'JOIN user_course uc ON co.usercourseid = uc.usercourse_id ',
            'JOIN copo_students_details csd ON mo.sid = csd.sid ',
            'WHERE uc.usercourse_id = ', userCourseID,
            ' GROUP BY csd.sid, csd.student_name, csd.stud_clg_id;'
        );
...
-- Dump completed on 2024-10-27  2:19:57
