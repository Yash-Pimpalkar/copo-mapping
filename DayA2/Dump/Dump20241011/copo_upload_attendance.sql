...
CREATE TABLE `upload_attendance` (
  ...
  `usecourseid` int DEFAULT NULL,
  `maxmarks` int DEFAULT NULL,
  PRIMARY KEY (`attid`),
  KEY `usercourseid_idx` (`usecourseid`),
  CONSTRAINT `usercourseid` FOREIGN KEY (`usecourseid`) REFERENCES `user_course` (`usercourse_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `upload_attendance` VALUES (1,7,20),(2,7,5),(3,8,5),(4,7,5),(6,3,10);
...
-- Dump completed on 2024-10-11  2:04:42
