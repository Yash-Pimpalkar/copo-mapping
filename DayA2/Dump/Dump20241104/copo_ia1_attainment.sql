...
INSERT INTO `ia1_attainment` VALUES (1,'CO1',76.76,3,3),(2,'CO2',20.33,0,3),(3,'CO4',34,NULL,4),(4,'CO1',55,NULL,4),(5,'CO3',79.34,3,7),(6,'CO4',89.39,3,7);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_insert_ia1` AFTER INSERT ON `ia1_attainment` FOR EACH ROW BEGIN
...
-- Dump completed on 2024-11-04 18:06:52
