...
export const editpos = (req, res) => {
    ...
    if (!po_id || !po_name || !po_body || !branch) { // Check for po_id and branch
...
export const savenewpos = (req,res) => {
    ...
    const sql = `
        INSERT INTO pos (po_id, po_name, po_body, created_time, branch_id)
    ...
    db.query(sql, values, (error, result) => {
        ...
        res.status(201).json({ message: "PO added successfully!", id: result.insertId });
    });
};
