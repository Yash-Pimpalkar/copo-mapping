            ...
            <div className="p-8 bg-gray-100 min-h-screen">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="flex space-x-4 mt-6">
                        <Link to='/editlmsquestions' className='bg-gray-200 text-gray-700 px-4 py-2 rounded border border-gray-300 hover:bg-gray-300'>
                            Edit Questions
                        </Link>
                        <Link to="" className="bg-gray-200 text-gray-700 px-4 py-2 rounded border border-gray-300 hover:bg-gray-300">
                            Preview questions
                        </Link>
