...
const CreateClassroom = () => {
  ...
  const semesters = ['Semester 1', 'Semester 2', 'Semester 3', 'Semester 4', 'Semester 5', 'Semester 6', 'Semester 7', 'Semester 8']; // Example semesters
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Classroom Created:', classroomName, 'Cohorts:', selectedCohorts, 'Year:', selectedYear, 'Department:', selectedDepartment, 'Semester:', selectedSemester);
  };
  ...
  return (
    <div className="bg-white shadow-md rounded p-6 mb-8">
      ...
      <form onSubmit={handleSubmit}>
        {/* Classroom Name */}
        <div className="mb-4">
          <label className="block mb-2" htmlFor="classroomName">Classroom Name</label>
          <input
            type="text"
            id="classroomName"
            value={classroomName}
        ...
        {/* Year Selection */}
        <div className="mb-4">
          <label className="block mb-2" htmlFor="year">Select Year</label>
          <select
            id="year"
            value={selectedYear}
        ...
        <div className="mb-4">
          <label className="block mb-2" htmlFor="department">Select Department</label>
          <select
            id="department"
        ...
        {/* Semester Selection */}
        <div className="mb-4">
          <label className="block mb-2" htmlFor="semester">Select Semester</label>
          <select
            id="semester"
          ...
          {cohorts.map((cohort) => (
            <div key={cohort} className="flex items-center mb-2">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor={cohort} className="cursor-pointer">{cohort}</label>
            </div>
          ))}
        </div>
